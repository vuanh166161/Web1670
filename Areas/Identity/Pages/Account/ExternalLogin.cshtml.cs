...
namespace FPTBook.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly IUserStore<BookUser> _userStore;
        private readonly IUserEmailStore<BookUser> _emailStore;
        ...
        private IUserEmailStore<BookUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<BookUser>)_userStore;
        }
    }
}
